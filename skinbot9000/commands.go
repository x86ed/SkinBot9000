...
var commands = []*discordgo.ApplicationCommand{
	{
		Name:        "jereme",
		Description: "J. Cassinova mode on this user. Takes a Kook and makes him into the GOAT skate rapper of all time",
		Options: []*discordgo.ApplicationCommandOption{
			...
			},
			{
				...
				Name:        "cancel",
				Description: "Cancel a user's J. Cassinova status",
				Required:    false,
			},
		},
	},
...
var commandHandlers = map[string]func(s *discordgo.Session, i *discordgo.InteractionCreate){
	// "jereme": func(s *discordgo.Session, i *discordgo.InteractionCreate) {
...
`
		if len(i.ApplicationCommandData().Options) >= 2 {
			margs = append(margs, i.ApplicationCommandData().Options[1].BoolValue())
			msgformat += "> cancel: %v\n"
		}
